...
final class VisualActivityViewController: UIActivityViewController {
    ...
    var previewNumberOfLines: Int = 0
    ...
    var previewFont: UIFont = UIFont.mainFont(ofSize: .medium)
    ...
    override init(activityItems: [Any], applicationActivities: [UIActivity]? = nil) {
    ...
    override func viewDidLoad() {
        ...
        preview = UIVisualEffectView(effect: UIBlurEffect(style: .prominent))
